...
const synth = {
  ...
  pad(ctx, t) {
    const osc = [220, 330, 440].map((freq) => {
  ...
  return (
    <div className="soundboard" onKeyDown={handleKeyDown} tabIndex={0}>
      <header className="soundboard-header">
        <h1>
          <span className="glitch" data-text="NEON_PADS">
            NEON_PADS
          </span>
          <span className="subtitle">// AUDIO_MATRIX</span>
        </h1>
        <p>
          Click a pad or press a key (<kbd>Q</kbd>–<kbd>Y</kbd>)
        </p>
      </header>
